...
const Chat = () => {
    ...
    const handleMessageChat = (data) => {
        ...
        // Mostrar inmediatamente el mensaje en el chat
    ...
    useEffect(() => {
        ...
        // Escuchar mensajes del backend (incluso los del bot)
                ...
                <div className="flex flex-col justify-center h-full">
                    <div className="flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
                        {responses.map((response, index) => (
                            <div
                                key={index}
                                className={`my-2 p-4 text-sm rounded-md text-white ${response.from === nameUser ? 'bg-slate-700 ml-auto' : 'bg-black mr-auto'}`}
                            >
